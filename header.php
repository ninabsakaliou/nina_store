    ...
    <nav class="navbar navbar-default navbar-fixed-top" id="scrollspy">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Nina_store</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li>
							<a href="mahasiswa.php"><span class="glyphicon glyphicon-hand-down"></span> </a>
						</li>
						<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-tasks"></span>jenis pakaian <span class="caret"></span>
						</a>
							<ul class="dropdown-menu">
								<li><a href="#">JEKET</a></li>
								<li><a href="#">GAUN PENGANTIN</a></li>
